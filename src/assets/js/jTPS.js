 ...
 (function($) {
        ...
        $.fn.jTPS = function ( opt ) {
                ...
                $(this).data('tableSettings', $.extend({
                        ...
                        perPageText:            'Hiện:',                                               // text that appears before perPages links
                        ...
                        function () {
                                ...
                                $(this).bind('click', 
                                        function () { 
                                                ...
                                                $('>.nav .status', pT).html( 'Hiện ' + ( cPos + 1 ) + ' - ' + ( cPos + ePos ) + ' của ' + rowCount + '' );
                                                clearSelection();
                                                // callback function after pagination renderd
                                                $(pT).data('tableSettings').clickCallback();
                                        }
                ...
                $('>.nav .status', this).html( 'Hiện ' + ( cPos + 1 ) + ' - ' + ( cPos + ePos ) + ' của ' + rowCount );
                                                ...
                                                function () {
                                                        ...
                                                        if ( $(this).hasClass('hilightPageSelector') ) {
                                                                if ( $(this).parent().queue().length > 0 ) {
                                                                        ...
                                                                        var cPos = $('>tbody>tr:not(.hideTR):first', pT).prevAll().length,
                                                                                ePos = $('>tbody>tr:not(.hideTR):not(.stubCell)', pT).length;
                                                                        $('>.nav .status', pT).html( 'Hiện ' + ( cPos + 1 ) + ' - ' + ( cPos + ePos ) + ' of ' + rowCount + '' );
                                                                }
                                                                clearSelection();
                                                                return false;
                                                        }
